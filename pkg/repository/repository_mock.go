...
func (m *RepositoryMock) GetUser(user models.User, opts ...utils.QueryOption) (models.User, error) {
	args := m.Called(user)
	return args.Get(0).(models.User), args.Error(1)
}

func (m *RepositoryMock) UserExists(email, username string, opts ...utils.QueryOption) bool {
